			...
			case 'prompt':
				return [
					...
					},
					{
						...
						value: `'changes', 'codebase', 'editFiles', 'extensions', 'fetch', 'githubRepo', 'new', 'openSimpleBrowser', 'problems', 'runCommands', 'runNotebooks', 'runTasks', 'runTests', 'search', 'searchResults', 'usages'`
					},
					{
						...
						value: [
							...
							`tools: ['changes', 'codebase', 'editFiles', 'extensions', 'fetch', 'githubRepo', 'new', 'openSimpleBrowser', 'problems', 'runCommands', 'runNotebooks', 'runTasks', 'runTests', 'search', 'searchResults', 'usages']`,
							`---`,
				...
				return [
					...
					},
					{
						...
						value: [
							...
							`model: GPT-4.1`,
							`tools: ['changes', 'codebase','extensions', 'fetch', 'githubRepo', 'openSimpleBrowser', 'problems', 'search', 'searchResults', 'usages']`,
							`---`,

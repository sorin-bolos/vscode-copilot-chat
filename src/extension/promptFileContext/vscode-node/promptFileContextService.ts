			...
			case 'prompt':
				return [
					...
					},
					{
						...
						value: `'changes', 'codebase', 'editFiles', 'extensions', 'fetch', 'new', 'openSimpleBrowser', 'problems', 'runCommands', 'runNotebooks', 'runTasks', 'runTests', 'search', 'searchResults', 'usages'`
					},
					{
						...
						value: [
							...
							`tools: ['changes', 'codebase', 'editFiles', 'extensions', 'fetch', 'new', 'openSimpleBrowser', 'problems', 'runCommands', 'runNotebooks', 'runTasks', 'runTests', 'search', 'searchResults', 'usages']`,
							`---`,
				...
				return [
					...
					},
					{
						...
						value: [
							...
							`model: GPT-4.1`,
							`tools: ['changes', 'codebase','extensions', 'fetch', 'openSimpleBrowser', 'problems', 'search', 'searchResults', 'usages']`,
							`---`,

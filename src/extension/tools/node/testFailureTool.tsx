	...
	render() {
		...
		return <>
			...
			<TextChunk priority={101}>
				...
				- If you need more information about anything in the codebase, use a tool like {ToolName.ReadFile} to find and read it. Never ask the user to provide it themselves.<br />

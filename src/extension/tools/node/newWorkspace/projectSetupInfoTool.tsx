...
const setupInfo: ProjectSetupInfo[] = [
	...
	},
	{
		...
		rules: [
			'Follow these rules strictly and do not deviate from them.',
			`1. Create a new Python script project in VS Code using the Python extension.`,
			`Use the command "python-envs.createNewProjectFromTemplate" with template "python-script".`,
		],
	},
	{
		...
		rules: [
			'Follow these rules strictly and do not deviate from them.',
			`1. Create a new Python package project in VS Code using the Python extension.`,
			`Use the command "python-envs.createNewProjectFromTemplate" with template "python-package".`,
		],
	},
];
		...
		if (useContext7) {
			return (
				<>
					{' '}
					<TextChunk>
						Use context7 tools to find the latest libraries, APIs,
						and documentation to help the user create and customize
						their project.
						<br />
						1. Call mcp_context7_resolve-library-id with your
						project requirements.
						<br />
						2. Call mcp_context7_get-library-docs to get scaffolding
						instructions.
						<br />
						You must call these tools before proceeding and confirm
						that you did NOT skip this step.
						<br />
						<br />
					</TextChunk>
				</>

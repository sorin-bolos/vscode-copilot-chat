		...
		return (
			<>
				<SystemMessage priority={1000}>
					You are an expert in crafting pithy titles for chatbot
					conversations. You are presented with a chat conversation,
					and you reply with a brief title that captures the main
					topic of discussion in that conversation.
					<br />
					<SafetyRules />
				</SystemMessage>
				...
				>
					<InstructionMessage priority={1000}>
						...
						The title should not be wrapped in quotes. It should
				...
				<UserMessage priority={900}>
					...
					If the conversation covers multiple topics, you can just

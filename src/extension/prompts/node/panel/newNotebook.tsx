...
export interface NewNotebookCodeGenerationPromptProps
...
interface GenerateNotebookConversationHistoryProps
	extends BasePromptElementProps {
...
export interface NewNotebookCodeImprovementPromptProps
	extends BasePromptElementProps {
	description: string;
	section: INotebookSection;
	existingCode: string;

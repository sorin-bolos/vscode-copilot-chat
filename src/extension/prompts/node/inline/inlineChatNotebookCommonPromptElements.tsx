...
export interface InlineChatNotebookSelectionCommonProps
...
interface InlineChatJupyterNotebookCellsContextRendererProps
	extends BasePromptElementProps {
	documentContext: IDocumentContext;
...
export interface CustomNotebookExampleRendererProps
	extends BasePromptElementProps {
	viewType: String;
}
...
export interface InlineChatCustomNotebookCellsContextRendererProps
	extends InlineChatNotebookSelectionCommonProps {
	aboveCells?: CodeContextRegion[];
	belowCells?: CodeContextRegion[];
}

...
interface InlineChatNotebookGenerateSelectionProps
	...
	override async prepare(): Promise<InlineChatNotebookSelectionState> {
		...
		const inSummaryExperiment =
			...
			this.configurationService.getConfig(
				ConfigKey.Internal.NotebookSummaryExperimentEnabled,
			);
...
interface InlineChatJupyterNotebookCellSummaryContextRendererProps

			...
			>
				...
				<div>
					...
					<div style={{ display: 'flex', gap: '10px' }}>
						...
						<Tooltip
							relationship="label"
							content="Do not send requests to the model endpoint (uses cache but doesn't write to it) (useful to make sure prompts are unchanged by observing cache misses)"
						>
							<Checkbox
								label="No fetch"

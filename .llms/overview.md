...
- **Search & Discovery**: `copilot_searchCodebase`, `copilot_findFiles`, `copilot_findTextInFiles`
- **Code Analysis**: `copilot_listCodeUsages`, `copilot_getErrors`, `copilot_searchWorkspaceSymbols`
